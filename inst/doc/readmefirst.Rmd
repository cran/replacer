...
The *Out-Data* result requires a User-made lookup file with index; the replacement requests are as follows:
  ...
  - split replacements: i.e. column "**a**" undergoes a split on the duplicated value "cc" present in 3 rows of *In-Data*; a *default* multiple replacement of length 3 was split in a length 2 multiple replacement at rows 3 and 6 replaced by "DD" and a simple replacement at row 12 replaced by "CA".
...
At the `R` prompt, type or just copy/paste the commands:
